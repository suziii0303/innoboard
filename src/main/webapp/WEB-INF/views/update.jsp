...
<body>
	<div>
	    <form id="updateForm" action="/board/updateBoard" method="POST">
	        <div>
	            <label for="boarId">번호 : </label>
	            <input type="text" id="num" name="num" value="${vo.num}" readonly="readonly"><br>
	            <label for="boarId">제목 : </label>
	            <input type="text" id="title" name="title" value="${vo.title}"><br>
	            <label for="boarId">작성자 : </label>
	            <input type="text" id="writer" name="writer" value="${vo.writer}" readonly="readonly"><br>
